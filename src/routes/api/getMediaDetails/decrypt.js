...
function Bt(t) {
    ...
    e.maxObjectSize = 1e8,
        ...
        e.parseFile = (t, e) => {
            ...
            return n.isBuffer(t) ? r(t) : void f.readFile(t, (t, n) =>{
...
export default class DecryptClass {
...
this.K = {}
this.K.read = function(t, e, r, n, o) {
    var i, a, s = 8 * o - n - 1, u = (1 << s) - 1, c = u >> 1, f = -7, l = r ? o - 1 : 0, h = r ? -1 : 1, p = t[e + l];
    for (l += h,
             i = p & (1 << -f) - 1,
             p >>= -f,
...
this.K.write = function (t, e, r, n, o, i) {
...
this.encry2arr_from = function(t, e, r) {  // 1  39  50  66
    return this.from_a(null, t, e, r)
}
...
hash(e) {
    ...
    return "string" == typeof e && (e = this.encry2arr_from(e)),this.to_string.call(this.o_default(e, 41405), 16).replace(/^0+/, "")
}

o_default() {  // 71  87  89  91

    return 2 == arguments.length ? this.digest(this.update(i_this.call(this,arguments[1]), arguments[0])) : this instanceof this.o_default ? void i_this.call(this, arguments[0]) : new o(arguments[0])
}
 ...
 from_a(t, e, r, n) {  // 2  38  51  65
    return false ? h(t, e, r, n) : "string" == typeof e ? this.f(t, e, r) : p(t, e)
}


 f(t, e, r) {  // 3  5  18  22  37  52  54  58  62  64
    var n = 0 | this.y(e, r);
    t = o_19(t, n);
    var a = this.write(t, e, r);
 ...
 V(t) {  // 9  13  16  25  29  33
    return this.toByteArray(this.q(t))
}


 q(t) {  // 10  12  26  28
    if (t = this.z(t).replace(/[^+\/0-9A-Za-z-_]/g, ""),
    t.length < 2)
        return "";
    for (; t.length % 4 != 0; )
        t += "=";
 ...
 write_E(t, e, r, n) {
    return this.X(this.Y(e, t.length - r), t, r, n)
}



 write(k, t, e, r, n) {  // 23  37  63
    if (void 0 === e)
        n = "utf8",
            r = k.length,
            e = 0;
 ...
 S_24(t, e, r, n) {  // 24  34  36
    return this.X(this.V(e), t, r, n)
}
...
// }
 ...
 decrypt(r){
    var a = this.encry2arr_from(r, "base64")  // 0
        , s = Math.max(Math.floor((a.length - 2 * this.i) / 3), 0)  // 40
        , u = a_slice(a,s, s + this.i);  // 41
    a =  this.concat([a_slice(a, 0, s), a_slice(a,s + this.i)]);  // 43  45  47
    var c_data = this.hash(this.concat([u,  this.encry2arr_from("")]));  // 49  67  69
    var l = {}
    l[c_data] = a
    var data = this.n_n((l = {},l[c_data] = a,l))
    return data
}
}